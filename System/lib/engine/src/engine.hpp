...
#define TT_ENGINE_FRONT_SHIFT(x) {TT_ENGINE_DIRECTION_FRONT, TT_ENGINE_SPEED_SHIFT(x)}
#define TT_ENGINE_BACK_SHIFT(x) {TT_ENGINE_DIRECTION_BACK, TT_ENGINE_SPEED_SHIFT(x)}
